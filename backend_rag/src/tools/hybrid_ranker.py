...
from src.models.runtime.retrieval import RankedSourceChunk, RetrievalChunkCandidate


class HybridRanker:
    """Combine dense vector scores with sparse BM25 lexical scores."""
    ...
    def score_sparse(
        ...
        """Score chunk candidates using BM25-style lexical relevance."""
    ...
    def fuse(
        ...
        """Fuse normalized dense+sparse scores into a ranked list."""
