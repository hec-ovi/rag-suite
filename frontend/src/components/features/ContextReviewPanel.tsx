      ...
      >
        <section className="mb-3 border border-border bg-background p-3">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <div className={`border p-3 text-left ${modeCardClass(contextMode === "llm")}`}>
              ...
              <div className="mt-3 flex justify-end">
                ...
                >
                  Generate agentic header
                </button>
              </div>
            </div>

            <div className={`border p-3 text-left ${modeCardClass(contextMode === "template")}`}>
            ...
            <div className={`border p-3 text-left ${modeCardClass(contextMode === "disabled")}`}>
