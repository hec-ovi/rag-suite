      ...
      >
        <section className="mb-3 border border-border bg-background p-3">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            ...
            <div className={`flex h-full flex-col border p-3 text-left ${modeCardClass(contextMode === "template")}`}>
            ...
            <div className={`flex h-full flex-col border p-3 text-left ${modeCardClass(contextMode === "disabled")}`}>
