  ...
  return (
    ...
    >
      <div className="mb-3 flex flex-wrap items-center gap-3">
        <label className="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-border bg-surface px-3 py-2 text-sm font-medium text-foreground">
          <input
            type="file"
      ...
      <label className="block text-sm text-muted">
        ...
        <textarea
          ...
          className="mt-1 h-52 w-full rounded-xl border border-border bg-background p-3 font-mono text-sm text-foreground"
