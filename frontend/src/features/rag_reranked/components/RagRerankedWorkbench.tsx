...
import { RagRerankedChatPanel } from "./RagRerankedChatPanel"
import { RagRerankedConfigPanel } from "./RagRerankedConfigPanel"
import { RagRerankedSessionPanel } from "./RagRerankedSessionPanel"
import { RagRerankedSourcesPanel } from "./RagRerankedSourcesPanel"
import type { RagRerankedActions, RagRerankedState } from "../hooks/useRagRerankedWorkflow"

interface RagRerankedWorkbenchProps {
  state: RagRerankedState
  actions: RagRerankedActions
}

export function RagRerankedWorkbench({ state, actions }: RagRerankedWorkbenchProps) {
  ...
  return (
    <div className="h-full min-h-0">
      ...
      <RagRerankedConfigPanel
        ...
        rerankCandidateCount={state.rerankCandidateCount}
        ...
        rerankModelOverride={state.rerankModelOverride}
